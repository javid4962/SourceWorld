...
export default function Profiles() {
   ...
   return (
      <>
         <Header />
         <h3 className="mb-0 m-3"># My Profiles</h3>
         <div className="container-fluid d-flex flex-column row">

               {/* <iframe src="https://leetcode.com/javid4962/" height={"500px"}></iframe> */}
            <div className="card my-3 mx-1 d-flex col-auto" >
               <div className="card-footer bg-primary text-white border rounded">
                  Coding Profiles
               </div>
               <ul className="list-group list-group-flush text-nowrap" >
                  
                  <li className="list-group-item d-flex flex-row justify-content-between overflow-scroll" >
            ...
            <div className="card m-3  p-1 border-0 col-auto">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis cumque eaque obcaecati magnam quidem commodi asperiores repellat eligendi ipsa facilis esse totam ut quasi praesentium, temporibus, itaque placeat illum a.</div>
         </div>
