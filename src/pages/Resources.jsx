...
function Resources() {
    ...
    return (
        <main>
            <Header />
            <h3 className="mb-0 m-3"># Resources</h3>
            <div className="album py-5 bg-body-tertiary m-0">
                    ...
                    <div className="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 g-3">
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3">
                                    <iframe src={freshershunt} className="border border-1 p-3" height={"450px"} loading="lazy"></iframe>
                                </div>
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3">
                                    <iframe src={fullstackadda} className="border border-1 p-3" height={"450px"} loading="lazy"></iframe>
                                </div>
                                <div className="d-flex justify-content-between align-items-center m-3">
                                    <div className="btn-group">
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3">
                                    <iframe src={frontlinesmedia} className="border border-1 p-3" height={"450px"} loading="lazy"></iframe>
                                </div>
                                <div className="d-flex justify-content-between align-items-center m-3">
                                    <div className="btn-group">
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3">
                                    <img src={placementlelo} className="border border-1 p-3" height={"450px"} loading="lazy"/>
                                </div>
                                <div className="d-flex justify-content-between align-items-center m-3">
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3">
                                    <iframe src={techfinder_img} className="border border-1 p-3" height={"450px"} loading="lazy"></iframe>
                                </div>
                                <div className="d-flex justify-content-between align-items-center m-3">
                                    <div className="btn-group">
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3">
                                    <img src={oflates_img} className="border image1 border-1 mx-auto d-block p-3 w-100 d-flex" height={"450px"} loading="lazy"/>
                                </div>
                                <div className="d-flex justify-content-between align-items-center m-3">
                                    <div className="btn-group">
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3">
                                    <iframe src={drivetube} className="border border-1 p-3" height={"450px"} loading="lazy"></iframe>
                                </div>
                                <div className="d-flex justify-content-between align-items-center m-3">
                                    <div className="btn-group">
                        ...
                        <div className="col">
                            <div className="card shadow-sm bg-dark">
                                ...
                                <div className="card-body ratio ratio-4x3 ">
                                    <img src={"/img_not_found1.jpg"} className="border border-1 p-3" height={"450px"} loading="lazy"/>
                                </div>
                                <div className="d-flex justify-content-between align-items-center m-3">
                                    <div className="btn-group">
